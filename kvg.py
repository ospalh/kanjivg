...
def createPathsSVG(f):
    ...
    out.write("""<!DOCTYPE svg PUBLIC "-//W3C//DTD SVG 1.0//EN" \
"http://www.w3.org/TR/2001/REC-SVG-20010904/DTD/svg10.dtd" []>
<svg xmlns="http://www.w3.org/2000/svg" width="109" height="109" \
viewBox="0 0 109 109" style="fill:none;stroke:#000000;stroke-width:3;\
...
def release():
    ...
    out.write("""\nThis file has been generated on %s, using the latest \
KanjiVG data\nto this date.""" % (datetime.date.today()))
    ...
    for f in files:
        ...
        kidend = data.find("\"")
        data = "<kanji id=\"kvg:kanji_%s\">" % (data[:kidend],) + data[
